...
**Strong match areas:** Python, PyTorch, LLM fine-tuning (LoRA/QLoRA, LLaMA 2/3), RAG architectures, agentic AI (LangChain/LangGraph), model serving (vLLM, LiteLLM, KServe, MLflow), FastAPI, Azure ML, Hugging Face Transformers, NLP pipelines/OCR, Docker/Kubernetes
**Moderate match areas:** SQL, JavaScript, C++, AWS, Kafka, Temporal workflows, PostgreSQL/MongoDB/Redis/Qdrant, microservices, CI/CD, React (used in Model Studio, not a frontend specialist)
**Weak match areas:** frontend-heavy roles, mobile development, embedded/systems programming, data engineering at petabyte scale (Spark/Flink), classical DevOps/SRE-only roles, roles requiring 5+ years experience (candidate has 2+)
...
**Strong:** production LLM systems (fine-tuning → serving → MLOps), healthcare AI / clinical document processing, ML platform engineering (no-code training platforms, compute orchestration), backend services around ML (FastAPI, Temporal, Kubernetes)
**Moderate:** general backend/software engineering without ML, data pipeline engineering (Kafka experience but not core), applied research roles (one publication, from-scratch transformer work)
**Entry-level:** engineering management, product management, roles requiring domain expertise outside healthcare/ML
...
**Career goals:**
- Grow as a machine learning / AI engineer on production-scale LLM systems (fine-tuning, serving, agentic AI)
- Move toward roles at companies building AI products or platforms (vs. pure services work)
- [PENDING — confirm longer-term direction with the candidate: IC depth vs. eventual lead track]

**Motivation filter:** Evaluate not just whether you *can* do the tasks, but whether the tasks will *energize* you. Consider:
- Tasks that energize: building end-to-end ML systems, LLM fine-tuning and serving, platform/infrastructure design, from-scratch implementations (evidenced by the LLM-from-scratch project) [inferred from CV — review]
- Tasks that drain: [PENDING — ask the candidate]
- Non-task factors: leadership style, department culture, company values, degree of autonomy

**Life situation alignment:** Consider personal constraints:
- **Security**: currently employed — can be selective; no urgency signal recorded
- **Flexibility**: target locations Bengaluru / Gurugram / Remote; no other schedule constraints recorded
- **Professional development**: production LLM/GenAI depth, exposure to larger-scale systems [inferred — review]
